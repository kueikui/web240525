...
namespace web_1
{
    public partial class Statistic : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //connection.Open();
            //MySqlCommand command = new MySqlCommand("SELECT fTime , COUNT(*) AS FallCount FROM Fall where eId = @eId GROUP BY fTime", connection);
            //command.Parameters.AddWithValue("@eId", TextBox1.Text);
