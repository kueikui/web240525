...
<style>
    ...
    <main aria-labelledby="title"> 
        ...
        <div>
            <!--<iframe width="20%" height="100%" src="https://www.youtube.com/embed/EALUEOo1O4I?si=pCq7WgXgufshDES4"></iframe>-->
  ...
  Your browser does not support the video tag.
        ...
        <div>
            <table style="border:none">
                <tr>
                    <td><asp:Button ID="Button1" runat="server" Text="一樓走廊-1" Width="100px"  /></td>
                    <td><asp:Button ID="Button2" runat="server" Text="一樓走廊-2" Width="100px" /></td>
                    <td><asp:Button ID="Button7" runat="server" Text="廚房" Width="100px" /></td>
                </tr>
                <tr>
                    <td> <asp:Button ID="Button8" runat="server" Text="客廳" Width="100px" /></td>
                    <td><asp:Button ID="Button9" runat="server" Text="玄關" Width="100px" /></td>
                    <td> <asp:Button ID="Button10" runat="server" Text="飯廳" Width="100px" /></td>
                </tr>
            </table>
